import { ref, hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, provide, createApp, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, inject, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
...
import { h as destr, k as klona, i as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, n as getRequestHeader, o as isEqual, s as sanitizeStatusCode, q as getContext, r as setCookie, v as getCookie, x as deleteCookie, y as createHooks, z as executeAsync, e as createError$1, A as withBase, B as toRouteMatcher, C as createRouter$1, D as defu } from '../_/nitro.mjs';
...
import { HttpLink, ApolloLink, from, ApolloClient, InMemoryCache } from '@apollo/client/core/index.js';
...
const Wo = (_a = class {
  constructor(o2 = [], a = {}) {
    ...
    for (const m of o2) {
      let h;
      ArrayBuffer.isView(m) ? h = new Uint8Array(m.buffer.slice(m.byteOffset, m.byteOffset + m.byteLength)) : m instanceof ArrayBuffer ? h = new Uint8Array(m.slice(0)) : m instanceof _a ? h = m : h = l.encode(`${m}`), __privateSet(this, _r, __privateGet(this, _r) + (ArrayBuffer.isView(h) ? h.byteLength : h.size)), __privateGet(this, _e).push(h);
    }
  ...
  slice(o2 = 0, a = this.size, l = "") {
    ...
    const S = Math.max(h - m, 0), E = __privateGet(this, _e), w = [];
    let A = 0;
    for (const b of E) {
      if (A >= S) break;
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-2vBYoHbS.mjs');
...
function createFetch(globalOptions = {}) {
  ...
  async function onError2(context) {
...
const unhead_lYH8qDroZ_BxefDNTUY4CVlpUsnQ65XyrrSBstijubo = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CEk2iVmb.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-CsT0XRvp.mjs')
  }
];
...
function isChangingPage(to, from2) {
  ...
  const areComponentsSame = to.matched.every(
    (comp, index) => {
      var _a2, _b2;
      return comp.components && comp.components.default === ((_b2 = (_a2 = from2.matched[index]) == null ? void 0 : _a2.components) == null ? void 0 : _b2.default);
    }
  );
...
const routerOptions0 = {
  scrollBehavior(to, from2, savedPosition) {
    ...
    const hookToWait = hasTransition(from2) && hasTransition(to) ? "page:transition:finish" : "page:loading:end";
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from2) => {
...
const plugin = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    router.afterEach((to, from2) => {
      var _a3, _b3, _c3, _d2;
      if (((_b3 = (_a3 = to.matched[0]) == null ? void 0 : _a3.components) == null ? void 0 : _b3.default) === ((_d2 = (_c3 = from2.matched[0]) == null ? void 0 : _c3.components) == null ? void 0 : _d2.default)) {
        syncCurrentRoute();
      }
    });
    const route = {};
...
const revive_payload_server_fK0EmhmsWJVpN9qZXFF4eob5MfrcyFdn1SQxdq4YhdM = /* @__PURE__ */ defineNuxtPlugin({
    ...
    ({ graphQLErrors, networkError, operation, forward }) => {
      ...
      if (graphQLErrors) {
        for (let { message, extensions } of graphQLErrors) {
          if (extensions.code === "FORBIDDEN" || extensions.code === "UNAUTHENTICATED") {
...
const apollo_client_xP0XJo7OPATlIIeRjGAKJ0sIKkWwvAJGzE1gieqRKaI = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const apolloClient = useCustomApollo();
  const customClient = useMutationApollo();
  nuxtApp.vueApp.provide(ApolloClients, {
    default: apolloClient,
    custom: customClient
    // 👈 this is the clientId you'll refer to
  });
});
const plugins = [
  unhead_lYH8qDroZ_BxefDNTUY4CVlpUsnQ65XyrrSBstijubo,
  plugin,
  revive_payload_server_fK0EmhmsWJVpN9qZXFF4eob5MfrcyFdn1SQxdq4YhdM,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  apollo_client_xP0XJo7OPATlIIeRjGAKJ0sIKkWwvAJGzE1gieqRKaI
];
defineComponent({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BgaPyrws.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CMeduCN1.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.1_@netlify+blobs@_dc1dcba8acf585c70a7cda5051f10927/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.1_@netlify+blobs@_dc1dcba8acf585c70a7cda5051f10927/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Yr as Y, Zt as Z, _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useCookie as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
